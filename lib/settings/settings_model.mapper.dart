...
class SettingsModelMapper extends ClassMapperBase<SettingsModel> {
  ...
  static SettingsModel _instantiate(DecodingData data) {
    return SettingsModel(style: data.dec(_f$style), tags: data.dec(_f$tags), plugins: data.dec(_f$plugins));
  }
...
mixin SettingsModelMappable {
  String toJson() {
    return SettingsModelMapper.ensureInitialized().encodeJson<SettingsModel>(this as SettingsModel);
  }

  Map<String, dynamic> toMap() {
    return SettingsModelMapper.ensureInitialized().encodeMap<SettingsModel>(this as SettingsModel);
  }

  SettingsModelCopyWith<SettingsModel, SettingsModel, SettingsModel> get copyWith =>
      _SettingsModelCopyWithImpl(this as SettingsModel, $identity, $identity);
  @override
  String toString() {
    return SettingsModelMapper.ensureInitialized().stringifyValue(this as SettingsModel);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            SettingsModelMapper.ensureInitialized().isValueEqual(this as SettingsModel, other));
  }

  @override
  int get hashCode {
    return SettingsModelMapper.ensureInitialized().hashValue(this as SettingsModel);
  }
}

extension SettingsModelValueCopy<$R, $Out> on ObjectCopyWith<$R, SettingsModel, $Out> {
  SettingsModelCopyWith<$R, SettingsModel, $Out> get $asSettingsModel =>
      $base.as((v, t, t2) => _SettingsModelCopyWithImpl(v, t, t2));
}

abstract class SettingsModelCopyWith<$R, $In extends SettingsModel, $Out> implements ClassCopyWith<$R, $In, $Out> {
  StyleSettingsModelCopyWith<$R, StyleSettingsModel, StyleSettingsModel> get style;
  TagSettingsModelCopyWith<$R, TagSettingsModel, TagSettingsModel> get tags;
  PluginSettingsModelCopyWith<$R, PluginSettingsModel, PluginSettingsModel> get plugins;
  $R call({StyleSettingsModel? style, TagSettingsModel? tags, PluginSettingsModel? plugins});
  SettingsModelCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _SettingsModelCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, SettingsModel, $Out>
    implements SettingsModelCopyWith<$R, SettingsModel, $Out> {
  _SettingsModelCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<SettingsModel> $mapper = SettingsModelMapper.ensureInitialized();
  @override
  StyleSettingsModelCopyWith<$R, StyleSettingsModel, StyleSettingsModel> get style =>
  ...
  @override
  PluginSettingsModelCopyWith<$R, PluginSettingsModel, PluginSettingsModel> get plugins =>
      $value.plugins.copyWith.$chain((v) => call(plugins: v));
  @override
  $R call({StyleSettingsModel? style, TagSettingsModel? tags, PluginSettingsModel? plugins}) =>
      $apply(FieldCopyWithData(
          {if (style != null) #style: style, if (tags != null) #tags: tags, if (plugins != null) #plugins: plugins}));
  @override
  ...
  @override
  SettingsModelCopyWith<$R2, SettingsModel, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
