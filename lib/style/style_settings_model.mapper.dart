...
class StyleSettingsModelMapper extends ClassMapperBase<StyleSettingsModel> {
  ...
  static ColorSchemeModelName _$colorSchemeName(StyleSettingsModel v) => v.colorSchemeName;
  static const Field<StyleSettingsModel, ColorSchemeModelName> _f$colorSchemeName =
      Field('colorSchemeName', _$colorSchemeName, opt: true, def: ColorSchemeModelName.blue);
  static ColorSchemeModel _$customColorScheme(StyleSettingsModel v) => v.customColorScheme;
  static const Field<StyleSettingsModel, ColorSchemeModel> _f$customColorScheme =
      Field('customColorScheme', _$customColorScheme, opt: true, def: ColorSchemeModel.blue);
  static TextThemeModelName _$textThemeName(StyleSettingsModel v) => v.textThemeName;
  static const Field<StyleSettingsModel, TextThemeModelName> _f$textThemeName =
      Field('textThemeName', _$textThemeName, opt: true, def: TextThemeModelName.poppins);
  ...
  static const Field<StyleSettingsModel, List<int>> _f$highlightColors =
      Field('highlightColors', _$highlightColors, opt: true, def: _highlightColors);
...
mixin StyleSettingsModelMappable {
  String toJson() {
    return StyleSettingsModelMapper.ensureInitialized().encodeJson<StyleSettingsModel>(this as StyleSettingsModel);
  }

  Map<String, dynamic> toMap() {
    return StyleSettingsModelMapper.ensureInitialized().encodeMap<StyleSettingsModel>(this as StyleSettingsModel);
  }

  StyleSettingsModelCopyWith<StyleSettingsModel, StyleSettingsModel, StyleSettingsModel> get copyWith =>
      _StyleSettingsModelCopyWithImpl(this as StyleSettingsModel, $identity, $identity);
  @override
  String toString() {
    return StyleSettingsModelMapper.ensureInitialized().stringifyValue(this as StyleSettingsModel);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            StyleSettingsModelMapper.ensureInitialized().isValueEqual(this as StyleSettingsModel, other));
  }

  @override
  int get hashCode {
    return StyleSettingsModelMapper.ensureInitialized().hashValue(this as StyleSettingsModel);
  }
}

extension StyleSettingsModelValueCopy<$R, $Out> on ObjectCopyWith<$R, StyleSettingsModel, $Out> {
  StyleSettingsModelCopyWith<$R, StyleSettingsModel, $Out> get $asStyleSettingsModel =>
      $base.as((v, t, t2) => _StyleSettingsModelCopyWithImpl(v, t, t2));
}

abstract class StyleSettingsModelCopyWith<$R, $In extends StyleSettingsModel, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  ColorSchemeModelCopyWith<$R, ColorSchemeModel, ColorSchemeModel> get customColorScheme;
  ...
  StyleSettingsModelCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _StyleSettingsModelCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, StyleSettingsModel, $Out>
  ...
  @override
  late final ClassMapperBase<StyleSettingsModel> $mapper = StyleSettingsModelMapper.ensureInitialized();
  @override
  ColorSchemeModelCopyWith<$R, ColorSchemeModel, ColorSchemeModel> get customColorScheme =>
      $value.customColorScheme.copyWith.$chain((v) => call(customColorScheme: v));
  @override
  ListCopyWith<$R, int, ObjectCopyWith<$R, int, int>> get textColors =>
      ListCopyWith($value.textColors, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(textColors: v));
  @override
  ListCopyWith<$R, int, ObjectCopyWith<$R, int, int>> get highlightColors =>
      ListCopyWith($value.highlightColors, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(highlightColors: v));
  @override
  $R call(
          {ColorSchemeModelName? colorSchemeName,
          ColorSchemeModel? customColorScheme,
  ...
  StyleSettingsModel $make(CopyWithData data) => StyleSettingsModel(
      ...
      customColorScheme: data.get(#customColorScheme, or: $value.customColorScheme),
  ...
  @override
  StyleSettingsModelCopyWith<$R2, StyleSettingsModel, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
